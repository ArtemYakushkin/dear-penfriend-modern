			...
			<Modal className="editProfile">
				...
				<ModalScroll>
					<Block>
						...
						<SubTitle>
							Manage your personal information to keep it accurate
							and up to date
						</SubTitle>
					</Block>
					...
					<Block>
						...
						<CoverImage>
							{form.cover && (
								<img src={form.cover} alt="Profile Cover" />
							)}
						</CoverImage>
					</Block>
							...
							<PersonalInfo>
								...
								<InputBox>
									...
									<InputCountry
										value={form.country}
										handleCountryChange={
											countryHook.handleCountryChange
										}
										filteredCountries={
											countryHook.filteredCountries
										}
										showCountryDropdown={
											countryHook.showCountryDropdown
										}
										setShowCountryDropdown={
											countryHook.setShowCountryDropdown
										}
										setCountry={(v) =>
											onChange('country')({
												target: { value: v },
